...
???request.setAttribute("modReq", modReq); --%>	
 ...
 <div class="container">
    <!-- page title -->
	<h2  class="mt-4 mb-3 text-center">수정(modifyForm)</h2>
	
	<form id="modifyForm" action="modify.do" method="post">
	 <div class="form-group">
	   <label for="no">작성자</label>
	   <input type="text" name="writerId" id="writerId" class="form-control" value="작성자id출력예정" readonly="readonly"/>
	  </div>
	 <div class="form-group">
	   <label for="no">글번호</label>
	   <input type="text" name="no" id="no" class="form-control" value="출력예정" readonly="readonly"/>
	  </div>
	 <div class="form-group">
	 	<label for="title">제목</label>
	 	<input type="text" name="title" id="title" class="form-control" value="출력예정"/>
	 </div>
	 <div class="form-group">
	 	<label for="content">내용</label>
	 	<textarea rows="5" name="content" id="content" class="form-control">출력예정</textarea>
	 </div>
